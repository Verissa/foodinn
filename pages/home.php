  ...
  <div class="container" >
    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="textbox os-animation" data-os-animation="zoomIn" data-os-animation-delay="0.5s">
        <h3>Location Name</h3>
        <select required name="location" style="border: hidden; font-size: 18px; font-weight: 400;margin-top: 5px; width: 70%; min-height: 41px; border-radius: 4px; padding: 7px;">
             <option value="" disabled selected>Osu, East Legon, Spintex </option>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="textbox os-animation" data-os-animation="zoomIn" data-os-animation-delay="0.5s">
        ...
        <input type="text" placeholder="KFC,Koffee Lounge, Marwako" name="restaurant" required= />
      </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="textbox1 os-animation" data-os-animation="zoomIn" data-os-animation-delay="0.5s">
        <h3>Cuisine Name</h3>
        <input type="text" placeholder="Spaghetti Bolognese, Fried Rice" name="cuisine" />
        <span class="search" onclick="return validate()"><a onclick="return validate()" href="search.php"><i class="fa fa-search" onclick="return validate()"></i></a></span> </div>
    </div>
  </form>
  </div>
</section>
