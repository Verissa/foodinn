...
<section class="saction3">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="ordaring">
          <h2 class="os-animation" data-os-animation="zoomIn" data-os-animation-delay="0.50s">New Customer registration</h2>
    ...
    <br>
        <form name="register" method="post" onsubmit="return validate2()" enctype="multipart/form-data" autocomplete="off" action="../includes/customer2.php" style="center">
    
        <p>Customer Name: <input type="text" class="form-group form-input" name="Cname" placeholder="Your name.." value="" ></p>
        <br>
...
<br>
   <p>Customer Password : <input type="password" class="form-group form-input" name="Cpassword" value="" autocomplete="false" placeholder="Your password.." required></p>
   <br>
   <p>Customer Birthday : <input type="date" class="form-group form-input" name="birthday" value=""  placeholder="Your birthday.." required></p>
    <br>    
        <p>Customer Contact: <input type="text"class="form-group form-input" id="contact" name="contact" placeholder="Telephone number.." value="" ></p>
<br>

        <p>Customer Address: <input type="text" class="form-group form-input"name="address" value="" placeholder="Your address.."></p>
        <br>
                <p>Customer Image: <input type="file"class="form-group form-input" name="image" id="file" accept="image/*"  /></p> 
<br>
